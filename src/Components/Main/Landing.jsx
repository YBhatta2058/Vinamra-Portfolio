  ...
  return (
    <motion.div id = "Home" initial = {{opacity: 0}} animate = {{opacity: 1,transition:{duration: .3,ease:"easeInOut"}}} className="landing">
        <div className="textContainer">
          ...
          <motion.h1 variants = {landingVariants} initial = "initial" animate = "animate">Event Manager and Event Coordinator</motion.h1>
          ...
          <motion.div className="btn" initial = {{opacity: 0}} animate = {{opacity: 1,transition:{duration: .3,delay:.5}}}>
            <a href = "" className = "resumeBtn">Resume<i className="fa-solid fa-arrow-up-right-from-square"></i></a>
